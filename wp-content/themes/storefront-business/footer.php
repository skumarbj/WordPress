...
$storefront_business_option['footer_section_background_color'] = '#f8f9fa';
	...
	<div class="row">
	  ...
	  <div class="vertical-center footer-bottom-section">
		...
		<div class="col-md-6 site-info">
		  <p align="center" style="color:#fff;" > <a href="<?php echo esc_url(new_york_business_THEME_AUTHOR_URL); ?>"> <?php echo wp_kses_post($storefront_business_option['footer_section_bottom_text']); ?> </a> </p>
		</div>
