...
if( !class_exists('new_york_business_settings') ){
	...
	class new_york_business_settings {
		...
		function default_data(){
			...
			'slider_button_text' => __("More details",'storefront-business'),
			...
			'contact_section_title' => __('Contact us','storefront-business'),
            ...
            'footer_section_bottom_text' =>  __('A Theme by Ceylon Themes','storefront-business'),			
