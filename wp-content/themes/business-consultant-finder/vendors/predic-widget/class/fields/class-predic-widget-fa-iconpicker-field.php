...
class Predic_Widget_Fa_Iconpicker_Field extends Predic_Widget_Form_Field {
    ...
    public function field() {
        ...
        $html .= '<section class="predic-widget-fa-iconpicker predic-widget-fa-iconpicker__field">';
		     ...
		     * Search field
		     */
		    $html .= '<input type="text" class="widefat predic-widget-fa-iconpicker__search" placeholder="' . esc_html__( 'Search icons', 'business-consultant-finder' ) . '"/>';
		     ...
		     * Clear button
		     */
	        $html .= '<button type="button" class="button predic-widget-fa-iconpicker__clear">' . esc_html__( 'Clear', 'business-consultant-finder' ) . '</button>';

		    /**
		     * Default value
		     */
	        if ( !empty( $this->default ) ) {
	            $html .= '<button type="button" class="button predic-widget-fa-iconpicker__default" data-default="' . esc_attr( $this->default ) . '">' . esc_html__( 'Default', 'business-consultant-finder' ) . '</button>';
	        }
    ...
    public static function admin_scripts( $hook ) {
        ...
        wp_enqueue_style( 'predic-widget-font-awesome', PREDIC_WIDGET_ASSETS_URL . '/vendor/font-awesome/css/font-awesome.css', array(), self::$version );
    ...
    private function get_icons_list() {
        ...
        $icons = ! empty( $this->icons ) ? $this->icons : $this->font_awesome_icons();
