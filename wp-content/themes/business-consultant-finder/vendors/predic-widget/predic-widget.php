...
class Predic_Widget {
    ...
    protected function __construct() {
        ...
        load_template ( PREDIC_WIDGET_ROOT_PATH . '/class/abstract/class-predic-widget-form-field.php' );
        load_template ( PREDIC_WIDGET_ROOT_PATH . '/class/class-predic-widget-factory.php' );
        load_template ( PREDIC_WIDGET_ROOT_PATH . '/class/class-predic-widget-builder.php' );
	...
	private function define_constants() {
		...
		$this->define( 'PREDIC_WIDGET_ROOT_URL', esc_url( get_template_directory_uri().'/vendors/predic-widget/' ) );
		$this->define( 'PREDIC_WIDGET_ROOT_PATH', untrailingslashit( get_template_directory().'/vendors/predic-widget/' ) );
    ...
    public function admin_scripts( $hook ) {
        ...
        wp_enqueue_style( 'predic-widget-admin-style', PREDIC_WIDGET_ASSETS_URL . '/css/admin.css', array(), $this->version );
    }
