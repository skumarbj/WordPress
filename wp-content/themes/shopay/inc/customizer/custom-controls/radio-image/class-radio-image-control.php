...
if ( ! class_exists( 'Shopay_Control_Radio_Image' ) ) {
    
    /**
	 * Radio Image control (modified radio).
    */
	class Shopay_Control_Radio_Image extends WP_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'shopay-radio-image-style', get_template_directory_uri() . '/inc/customizer/custom-controls/radio-image/radioimage.css', null );
            wp_enqueue_script( 'shopay-radio-image-script', get_template_directory_uri() . '/inc/customizer/custom-controls/radio-image/radioimage.js', array( 'jquery' ), false, true );
        }
