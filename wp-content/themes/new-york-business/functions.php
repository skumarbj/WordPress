...
//show, hide notice, update_option('new_york_business_notice',1);
if ( isset( $_GET['new_york_business_notice_dismissed'] ) ){
	update_option('new_york_business_notice', 17);
}

$new_york_business_notice = get_option('new_york_business_notice', 0);
if($new_york_business_notice != 17){
