...
if ( ! class_exists( 'Gutentor_Post_Module_Hooks' ) ) {
	...
	class Gutentor_Post_Module_Hooks{
		...
		public function run(){
            ...
            $this->add_filter( 'gutentor_post_module_before_block_items', $this, 'addAdvancedBlockShapeTop',15,2);
            $this->add_filter( 'gutentor_post_module_after_block_items', $this, 'addAdvancedBlockShapeBottom',15,2);
		...
		public function add_main_wrap_classes( $output, $attributes ){
			...
			$block_list             = array('gutentor/p1','gutentor/post1');
