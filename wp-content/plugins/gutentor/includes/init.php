...
class Gutentor {
	...
	private function load_dependencies() {
		...
		require_once GUTENTOR_PATH . 'includes/blocks/class-post1.php';/* ***Do not remove required for PHP BLOCK*/
		require_once GUTENTOR_PATH . 'includes/blocks/class-post2.php';/* ***Do not remove required for PHP BLOCK*/
